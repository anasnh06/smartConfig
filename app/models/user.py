...
# ✅ Import explicite des modèles utilisés dans les relations
from app.models.server import Server
from app.models.project import Project
from app.models.configuration import Configuration
from app.models.environment import Environment
from app.models.role import Role
from app.models.os import OperatingSystem
...
from app.models.server_configuration import ServerConfiguration
...
class User(Base):
    ...
    execution_groups_created = relationship("ExecutionGroup", back_populates="created_by_user", foreign_keys=[ExecutionGroup.created_by])
    execution_groups_updated = relationship("ExecutionGroup", back_populates="updated_by_user", foreign_keys=[ExecutionGroup.updated_by])
